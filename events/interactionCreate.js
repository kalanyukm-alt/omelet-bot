...
const ROLE_CONFIG = {
    ...
    buy_somjeed: { modalId: 'modal_somjeed', title: 'โดเนทให้ ส้มจี๊ด (10 บาท)', roleId: '1517102688779767829', roleName: 'ส้มจี๊ด', amount: 10 }, // 🍹 เพิ่มของ ส้มจี๊ด เรียบร้อย!
    buy_muna: { modalId: 'modal_muna', title: 'โดเนทให้ มูนา (10 บาท)', roleId: '1517943037253128406', roleName: 'มูนา', amount: 10 }, // 🖤 เพิ่มของ มูนา เรียบร้อย!
    ...
    buy_punch: { modalId: 'modal_punch', title: 'โดเนทให้ พั้นช์ (55 บาท)', roleId: '1538023689910755409', roleName: 'พั้นช์', amount: 55 }, // 🩷 เพิ่มของ พั้นช์ เรียบร้อย!
    buy_seren: { modalId: 'modal_seren', title: 'โดเนทให้ เซเรน (55 บาท)', roleId: '1539765929099923546', roleName: 'เซเรน', amount: 55 }, // 💙 เพิ่มของ เซเรน เรียบร้อย!
    buy_aurea: { modalId: 'modal_aurea', title: 'โดเนทให้ ออเรีย (50 บาท)', roleId: '1540517583151829124', roleName: 'ออเรีย', amount: 50 }, // 🩵 เพิ่มของ ออเรีย เรียบร้อย!
    buy_lukwa: { modalId: 'modal_lukwa', title: 'โดเนทให้ ลูกหว้า (55 บาท)', roleId: '1543464539322974280', roleName: 'ลูกหว้า', amount: 55 }, // 🩷 เพิ่มของ ลูกหว้า เรียบร้อย!
    buy_sky: { modalId: 'modal_sky', title: 'โดเนทให้ สกาย (55 บาท)', roleId: '1544153385723240448', roleName: 'สกาย', amount: 55 }, // 🩵 เพิ่มของ สกาย เรียบร้อย!
    buy_yumi: { modalId: 'modal_yumi', title: 'โดเนทให้ ยูมิ (50 บาท)', roleId: '1544855841948180530', roleName: 'ยูมิ', amount: 50 }, // 🎱 เพิ่มของ ยูมิ เรียบร้อย!
    buy_gigi: { modalId: 'modal_gigi', title: 'โดเนทให้ จีจี้ (50 บาท)', roleId: '1546346240650772520', roleName: 'จีจี้', amount: 50 }, // 🧡 เพิ่มของ จีจี้ เรียบร้อย!
    buy_mila: { modalId: 'modal_mila', title: 'โดเนทให้ มิล่า (55 บาท)', roleId: '1547785514013302934', roleName: 'มิล่า', amount: 55 }, // 💚 เพิ่มของ มิล่า เรียบร้อย!
    buy_yada: { modalId: 'modal_yada', title: 'โดเนทให้ ญาดา (55 บาท)', roleId: '1548110478683807794', roleName: 'ญาดา', amount: 55 }, // ❤️ เพิ่มของ ญาดา เรียบร้อย!
}; 
